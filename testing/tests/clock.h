extern void test_clock_tz(void);
extern void test_clock_simple_binary(void);
extern void test_clock_prodos_binary(void);
extern void test_clock_apetime_binary(void);
