...
enum {
  ...
  PRINTERCMD_WRITE                   = 0x57, // W
  PRINTERCMD_STATUS                  = 0x53, // S
  PRINTERCMD_PUT                     = 0x50, // P

  PCLINKCMD_STATUS                   = 0x53, // S
  PCLINKCMD_EXEC                     = 0x52, // R
  PCLINKCMD_PARBLK                   = 0x50, // P
  PCLINKCMD_HSI                      = 0x3F, // ?
};
